...
<body>
    ...
    <header class = "header bg-blue">
        <nav class = "navbar bg-blue">
            <div class="logo">
                <img src = "/imagem para o site/Captura de tela 2023-10-22 164116 (1).png" alt = "logotipo do site" >
            </div>
            <div class = "container flex">
                ...
                <div class = "navbar-collapse bg-white">
                    ...
                    <ul class = "navbar-nav">
                        ...
                        <li class = "nav-item">
                            <a href = "graficos.php" class = "nav-link">Graficos</a>
                        </li>
                        <!-- lista dropdown -->
                        <div class="dropdown">
                            <button class="dropbtn"><b>Cadastrar</b></button>
                            <div class="dropdown-content">
                              <a href="./cadastro-p.php">Paciente</a>
                              <a href="./cadastro-m.php">Médico</a>
                            </div>
                          </div>
                        <!-- <li class = "nav-item">
